...
2. **Fast Execution**: ~500ms per test vs 10+ seconds for Docker tests
3. **Accurate Behavior**: Uses actual HA components, not mocks
4. **Easy Debugging**: Direct access to HA internals
5. **CI/CD Friendly**: No Docker required, runs anywhere
