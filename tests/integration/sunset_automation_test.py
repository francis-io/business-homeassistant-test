...
class TestSunsetAutomation:
    ...
    @pytest.mark.asyncio
    async def test_sunset_automation_triggers_light(self, hass: HomeAssistant, automation_config):
    ...
    @pytest.mark.asyncio
    async def test_automation_loads_from_yaml(self, hass: HomeAssistant, automation_config):
    ...
    @pytest.mark.asyncio
    async def test_sunset_trigger_configuration(self, hass: HomeAssistant, automation_config):
    ...
    @pytest.mark.asyncio
    async def test_light_state_after_automation(self, hass: HomeAssistant, automation_config):
