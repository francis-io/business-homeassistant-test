...
def load_and_validate_automation(yaml_path: str) -> dict[str, Any]:
...
@pytest.fixture
def my_automation() -> dict[str, Any]:
...
def test_automation_validation() -> None:
...
def test_invalid_automation_detection() -> None:
    ...
    bad_automation = {
        ...
        "action": [
            {"service": "turn_on"},
            {"delay": {}},
        ],  # Missing domain  # Missing time units
    }
...
def test_with_assert_helper() -> None:
    ...
    bad_automation = {"action": [{"service": "invalid"}]}  # Missing trigger and bad service
